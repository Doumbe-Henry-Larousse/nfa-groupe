...
<meta charset="utf-8">
<title>@yield('title', 'services Spécialisés')</title>
<!-- Stylesheets -->
...
<body>
    ...
    <!-- Start main-content -->
	<section class="page-title" style="background-image: url(images/background/accueil-servicesSp.jpg);">
		<div class="auto-container">
			<div class="title-outer text-center">
				...
				<h1 class="title">Services Spécialisés</h1>
			</div>
		</div>
	</section>
	<!-- end main-content -->
