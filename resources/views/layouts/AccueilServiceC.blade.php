...
<meta charset="utf-8">
<title>@yield('title', 'service Commercial')</title>
<!-- Stylesheets -->
...
<body>
    ...
    <!-- Start main-content -->
	<section class="page-title" style="background-image: url(images/background/accueil-nettoyageC.jpg);">
		<div class="auto-container">
			<div class="title-outer text-center">
				...
				<h1 class="title">Nettoyage commercial </h1>
			</div>
		</div>
	</section>
	<!-- end main-content -->
