    ...
    <!--[if mso | IE]>
      ...
      >
        <tr>
          <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
      <![endif]-->
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;border-radius:20px 20px 20px 20px;max-width:600px;">
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:30px;text-align:left;color:#54595f;">
                        <h2 style="margin: 0; line-height: normal; font-weight: bold; font-size: 20px;"> Hey, NFA Groupe</h2>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: bold;">Vous avez un nouveau message.</h1>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong> Nom </strong> : {{ $data['name'] }}  </p>
                      </div>
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong> Code Postal </strong> : {{ $data['code'] }}   </p>
                      </div>
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong>Téléphone : </strong> : {{ $data['phone'] ?? 'Non renseigné' }}    </p>
                      </div>
                        <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong>Type de Service : </strong> : {{ $data['type_service'] }}    </p>
                      </div>
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong>Date : </strong> : {{ $data['date'] }}    </p>
                      </div>
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong>Heure : </strong> : {{ $data['heure'] }}    </p>
                      </div>
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong> Paiement </strong> : {{ $data['paiement'] }}  </p>
                      </div>
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-style:italic;font-weight:400;line-height:22px;text-align:left;color:#54595f;">
                        <p style="margin: 0;"><strong> Détail : </strong> {{ $data['detail'] }}  </p>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Nunito, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:22px;text-align:left;color:#54595f;">Si vous avez des questions, répondez simplement à cet e-mail et nous serons plus qu'heureux de vous répondre</div>
                    </td>
                  </tr>
                </table>
              </div>
